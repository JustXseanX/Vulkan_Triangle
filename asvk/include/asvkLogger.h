...
//-------------------------------------------------------------------------------------------------
    ...
    #define DLOGA( fmt, ... )      asvk::SystemLogger::GetInstance().LogA( asvk::LogLevel::Debug, "[File: %s, Line: %d] "fmt"\n", __FILE__, __LINE__, ##__VA_ARGS__ )
  #else
...
#ifndef DLOGW
  #if defined(DEBUG) || defined(_DEBUG)
    #define DLOGW( fmt, ... )      asvk::SystemLogger::GetInstance().LogW( asvk::LogLevel::Debug, ASVK_WIDE("[File: %s, Line: %d] ") ASVK_WIDE(fmt) ASVK_WIDE("\n"), ASVK_WIDE(__FILE__), __LINE__, ##__VA_ARGS__ )
  #else
...
#ifndef ILOGA
#define ILOGA( fmt, ... )      asvk::SystemLogger::GetInstance().LogA( asvk::LogLevel::Info, fmt "\n", ##__VA_ARGS__ )
#endif//ILOGA

#ifndef ILOGW
#define ILOGW( fmt, ... )      asvk::SystemLogger::GetInstance().LogW( asvk::LogLevel::Info, ASVK_WIDE(fmt) ASVK_WIDE("\n"), ##__VA_ARGS__ );
#endif//ILOGW

#ifndef ELOGA
#define ELOGA( fmt, ... )      asvk::SystemLogger::GetInstance().LogA( asvk::LogLevel::Error, "[File: %s, Line: %d] " fmt "\n", __FILE__, __LINE__, ##__VA_ARGS__ )
#endif//ELOGA

#ifndef ELOGW
#define ELOGW( fmt, ... )      asvk::SystemLogger::GetInstance().LogW( asvk::LogLevel::Error, ASVK_WIDE("[File: %s, Line: %d] ") ASVK_WIDE(fmt) ASVK_WIDE("\n"), ASVK_WIDE(__FILE__), __LINE__, ##__VA_ARGS__ )
#endif//ELOGW
